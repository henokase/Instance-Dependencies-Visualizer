  ...
  const renderTable = (startIndex: number, endIndex: number) => (
    <div className="flex-1 overflow-x-auto">
      <table className="w-full border-collapse">
        <thead>
          <tr>
            <th className="p-3 bg-gray-100 border border-gray-300 font-semibold text-left">Instance</th>
            <th className="p-3 bg-gray-100 border border-gray-300 font-semibold text-left">Dependencies</th>
          </tr>
        </thead>
        <tbody>
