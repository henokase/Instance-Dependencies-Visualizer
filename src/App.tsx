        ...
        <div className="mb-8">
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg border border-gray-300 bg-white py-2 px-4 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
              value={searchTerm}
